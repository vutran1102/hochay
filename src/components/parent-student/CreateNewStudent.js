...
export class CreateNewStudent extends Component {
    constructor(props) {
        super(props);
        this.state = {
        ...
        return (
            <View style={{ flex: 1 }}>
                ...
                <View style={styles.wrapCotainer}>
                    <StudentForm ref='studentform' navigation={this.props.navigation} backCallback={this.props.backCallback.bind(this)}>
